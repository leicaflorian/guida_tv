  ...
  public function parseChannelsGroup($type, $dom, $containerId): void {
    ...
    foreach ($channelsDOMElements as $channel) {
      ...
      $newChannel = (new Channel([
        ...
        'logo_url_color' => sprintf($this->logoUrlColor, Str::slug($channel->getAttribute("title"))),
        'logo_url_light' => sprintf($this->logoUrlWhite, Str::slug($channel->getAttribute("title"))),
        'type'           => $type
      ]));
